...
@section('title', 'Dashboard Kepala BPS')
    ...
    <div class="welcome-banner">
        <div class="welcome-content">
            ...
            <div>
                ...
                <p>Kelola dan setujui pengajuan pinjaman dari anggota koperasi dengan mudah</p>
            </div>
        </div>
    </div>
        ...
        <div class="table-header">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div>
                    ...
                    <p>Verifikasi dan setujui pengajuan pinjaman dari anggota koperasi</p>
                </div>
                <div class="table-header-badge">
                    <i class="bi bi-list-check"></i>
                    <span>{{ count(array_filter($pengajuan, fn($p) => $p['status'] == 'Menunggu')) }} Pengajuan</span>
                </div>
            </div>
        </div>
                    ...
                    @foreach ($pengajuan as $p)
                        @if ($p['status'] == 'Menunggu')
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('kepala_bps.detail', $p['id']) }}" class="btn-detail">
                                        <i class="bi bi-eye"></i>
                                        <span>Detail</span>
                                    </a>
                                </td>
