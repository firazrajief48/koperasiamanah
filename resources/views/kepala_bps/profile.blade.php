        ...
        <div class="profile-card">
            <div class="profile-header">
                ...
                <div class="profile-info">
                    <h1>{{ $user->name }}</h1>
                    <div class="role">{{ $user->jabatan ?? 'Kepala BPS' }}</div>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <table class="info-table">
                    ...
                    <tr>
                        ...
                        <td class="value-col">{{ $user->jabatan ?? 'Kepala BPS' }}</td>
                    </tr>
                    <tr>
    ...
    <div class="modal fade" id="editPhotoModal" tabindex="-1" aria-labelledby="editPhotoModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('kepala_bps.profile.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('kepala_bps.profile.update') }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="row">
