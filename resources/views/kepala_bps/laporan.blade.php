    ...
    <div class="page-header-modern">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <small>Daftar pinjaman yang telah diverifikasi dan riwayat verifikasi lengkap</small>
            </div>
        </div>
    </div>
    ...
    <div class="filter-container">
        <div class="filter-tabs">
            ...
            <button class="filter-tab" data-filter="Diverifikasi">
                ...
                <span>Disetujui</span>
                <span class="badge">{{ collect($laporan)->filter(function($item) { return data_get($item, 'status', '') === 'Diverifikasi'; })->count() }}</span>
            </button>
            <button class="filter-tab" data-filter="Ditolak">
                <i class="bi bi-x-circle-fill"></i>
                <span>Ditolak</span>
                <span class="badge">{{ collect($laporan)->filter(function($item) { return data_get($item, 'status', '') === 'Ditolak'; })->count() }}</span>
            </button>
            <!-- Vinalisasi stage: only 'Diverifikasi' and 'Ditolak' statuses exist -->
        </div>
    </div>
        ...
        <div class="table-header">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div>
                    ...
                    <p>Klik "Detail" untuk melihat informasi lengkap pinjaman anggota</p>
                </div>
            </div>
        </div>
                        ...
                        <tr data-status="{{ $status }}" data-verifier="{{ $verifier }}">
                            <td>
                                <div class="name-cell">
                                    ...
                                    <div class="name-info">
                                        ...
                                        <div class="name-secondary">{{ $l['nip'] ?? 'Anggota Koperasi' }}</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="date-badge">
                                    ...
                                    <span>{{ $rawTanggal ? date('d/m/Y', strtotime($rawTanggal)) : '-' }}</span>
                                </div>
                            </td>
                            <td>
