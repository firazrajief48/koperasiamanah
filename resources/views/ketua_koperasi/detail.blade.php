...
@php
    ...
    // Data yang diambil dari backend/database
    ...
    $gajiPokok = $pengajuan['gaji_pokok'] ?? 8000000;
    $sisaGaji = $pengajuan['sisa_gaji'] ?? 7000000;

    // Tabel pinjaman - sesuai dengan logika tabel (maksimal 10 juta)
    $tabelPinjaman = [
        3000000 => [
    ...
    // Ambil cicilan per bulan dari tabel OTOMATIS berdasarkan data dari DB
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                ...
                                <div class="info-value">Rp {{ number_format($gajiPokok, 0, ',', '.') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                ...
                                <div class="info-value">Rp {{ number_format($sisaGaji, 0, ',', '.') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body-modern">
            <form id="formVerifikasi">
                ...
                <div class="action-buttons">
                    ...
                    <a href="{{ route('ketua_koperasi.dashboard') }}" class="btn-modern btn-back">
