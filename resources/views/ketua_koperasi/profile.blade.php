...
@section('main-content')
    ...
    <div class="welcome-banner">
        <div class="welcome-content">
            ...
            <div>
                <h2>{{ $user->name }}</h2>
                <p>{{ $user->jabatan ?? 'Ketua Koperasi' }} • Kelola informasi akun Anda</p>
            </div>
            </div>
        </div>
        ...
        <div class="info-card">
            ...
            <div class="info-card-body">
                <table class="info-table">
                    ...
                    <tr><td class="label-col">Jabatan</td><td class="value-col">{{ $user->jabatan ?? 'Ketua Koperasi' }}</td></tr>
    ...
    <div class="modal fade" id="editPhotoModal" tabindex="-1" aria-labelledby="editPhotoModalLabel" aria-hidden="true">
        <div class="modal-dialog"><div class="modal-content">
            ...
            <form action="{{ route($routePrefix . '.profile.update') }}" method="POST" enctype="multipart/form-data">@csrf @method('PUT')
                <input type="hidden" name="update_type" value="photo">
                <div class="modal-body">
                    <div class="text-center mb-3"><div class="profile-avatar-banner mx-auto mb-3">@if($user->photo && file_exists(public_path('storage/' . $user->photo)))<img src="{{ asset('storage/' . $user->photo) }}" alt="{{ $user->name }}">@else<i class="bi bi-person"></i>@endif</div><p class="text-muted">Foto saat ini</p></div>
