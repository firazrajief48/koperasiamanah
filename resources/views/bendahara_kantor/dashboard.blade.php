...
@section('page-title', 'Dashboard Bendahara Kantor')
    ...
    <div class="dashboard-container">
        <div class="dashboard-card">
            <div class="card-header">
                <h5><i class="bi bi-file-earmark-text me-2"></i>Daftar Pinjaman Masuk (Belum Diverifikasi)</h5>
            </div>
                        ...
                        @foreach ($pengajuan as $p)
                            @if ($p['status'] == 'Menunggu')
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('bendahara_kantor.detail', $p['id']) }}" class="btn btn-sm btn-primary">Detail</a>
                                    </td>
                                </tr>
                            @endif
                        @endforeach
