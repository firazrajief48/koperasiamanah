        ...
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25);">
                <div class="modal-header border-0">
                    <h5 class="modal-title" style="font-weight: 600; color: #1e293b;">Ganti Foto Profile</h5>
                ...
                <div class="modal-footer border-0">
                    <button type="button" class="btn" style="color: #64748b; font-weight: 500;" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary px-4" style="background: #3b82f6; border-radius: 8px; font-weight: 500;" onclick="simpanFoto()">Simpan Foto</button>
                </div>
            </div>
        </div>
    </div>
