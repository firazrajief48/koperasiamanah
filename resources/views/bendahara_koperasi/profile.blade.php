...
@section('main-content')
    {{-- ============================================================
        BAGIAN CSS - STYLING HALAMAN PROFILE
    ============================================================ --}}
    <style>
        /* ==================== VARIABLES & GENERAL ==================== */
        :root {
    ...
    {{-- ============================================================
        BAGIAN HTML - STRUKTUR HALAMAN PROFILE
    ============================================================ --}}
    
    {{-- CONTAINER UTAMA --}}
    <div class="profile-container">
        
        {{-- HEADER CARD DENGAN FOTO PROFILE --}}
    ...
    {{-- ============================================================
        BAGIAN JAVASCRIPT - FUNGSI-FUNGSI INTERAKTIF
    ============================================================ --}}
    @push('scripts')
        <script>
            /* ==================== VARIABEL GLOBAL ==================== */
