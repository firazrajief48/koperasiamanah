...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Edit informasi user {{ $user->name }}</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('administrator.detail-user', $user->id) }}" class="btn btn-info">
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-header bg-transparent border-0 p-4">
                    <h5 class="fw-bold mb-0" style="color: var(--dark-navy);">
                        <i class="bi bi-form me-2"></i>Form Edit User
                    </h5>
                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('role') is-invalid @enderror"
                                    ...
                                    <option value="peminjam" {{ old('role', $user->role) == 'peminjam' ? 'selected' : '' }}>Anggota</option>
