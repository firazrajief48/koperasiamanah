...
@section('main-content')
    <style>
        ...
        .profile-avatar-banner img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        }

        .profile-avatar-banner i {
            font-size: 2.5rem;
            color: white;
        }
        ...
        .modal-footer .btn-danger { background: linear-gradient(135deg, #ef4444 0%, #f87171 100%); color: white; box-shadow: 0 4px 12px rgba(239, 68, 68, 0.3); }
        .modal-footer .btn-danger:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(239, 68, 68, 0.4); background: linear-gradient(135deg, #dc2626 0%, #ef4444 100%); }
        ...
        @media (max-width: 768px) {
            ...
            .welcome-content { flex-direction: column; align-items: flex-start; gap: 0.75rem; }
            .welcome-banner h2 { font-size: 1.25rem; }
            .action-buttons-card { padding: 1.25rem 1.5rem; }
            .action-buttons-grid { grid-template-columns: 1fr; }
            .info-cards-grid { grid-template-columns: 1fr; }
            .info-card-header, .info-card-body { padding: 1.25rem 1.5rem; }
        }
    ...
    <div class="welcome-banner">
        <div class="welcome-content">
            ...
            <div>
                <h2>{{ $user->name }}</h2>
                <p>{{ $user->jabatan ?? 'Administrator' }} • Kelola informasi akun Anda</p>
            </div>
        </div>
    </div>
                    ...
                    if (file) {
                        ...
                        reader.onload = function(e) {
                            ...
                            if (previewImg) {
                                ...
                                const container = previewIcon.parentElement;
