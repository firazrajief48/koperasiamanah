...
class KepalaKoperasiController extends Controller
{
    public function dashboard()
    {
        ...
        return view('kepala_koperasi.dashboard', compact('pengajuan'));
    }
    ...
    public function detailPengajuan($id)
    {
        ...
        return view('kepala_koperasi.detail', compact('pengajuan'));
    }
    ...
    public function laporanPinjaman()
    {
        ...
        return view('kepala_koperasi.laporan', compact('laporan'));
    }
    ...
    public function transparansi()
    {
        ...
        return view('kepala_koperasi.transparansi', compact('pinjaman'));
    }
    ...
    public function profile()
    {
        ...
        return view('kepala_koperasi.profile', compact('user'));
    }
}
