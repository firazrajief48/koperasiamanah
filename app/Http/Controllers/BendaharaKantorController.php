...
class BendaharaKantorController extends Controller
{
    public function dashboard()
    {
        ...
        return view('bendahara_kantor.dashboard', compact('pengajuan'));
    }
    ...
    public function detailPengajuan($id)
    {
        ...
        return view('bendahara_kantor.detail', compact('pengajuan'));
    }
    ...
    public function laporanPinjaman()
    {
        ...
        return view('bendahara_kantor.laporan', compact('laporan'));
    }
    ...
    public function transparansi()
    {
        ...
        return view('bendahara_kantor.transparansi', compact('pinjaman'));
    }
    ...
    public function profile()
    {
        ...
        return view('bendahara_kantor.profile', compact('user'));
    }
}
